...
public class RegistryDirectory<T> extends AbstractDirectory<T> implements NotifyListener {
    ...
    private void refreshInvoker(List<URL> invokerUrls) {
        ...
        // TODO: 2019/3/14 invokerUrls 仅有一个元素，且 url 协议头为 empty，此时表示禁用所有服务
        if (invokerUrls.size() == 1 && invokerUrls.get(0) != null && Constants.EMPTY_PROTOCOL.equals(invokerUrls
            ...
            // TODO: 2019/3/14 将 url 转成 Invoker
            ...
            // TODO: 2019/3/14 将 newUrlInvokerMap 转成方法名到 Invoker 列表的映射
            List<Invoker<T>> newInvokers = Collections.unmodifiableList(new ArrayList<>(newUrlInvokerMap.values()));
            // pre-route and build cache, notice that route cache should build on original Invoker list.
            // toMergeMethodInvokerMap() will wrap some invokers having different groups, those wrapped invokers not should be routed.
            routerChain.setInvokers(newInvokers);
            // TODO: 2019/3/14 合并多个组的 Invoker
    ...
    private Map<String, Invoker<T>> toInvokers(List<URL> urls) {
        ...
        for (URL providerUrl : urls) {
            ...
            if (queryProtocols != null && queryProtocols.length() > 0) {
                ...
                // TODO: 2019/3/14 检测服务提供者协议是否被服务消费者所支持
            ...
            // TODO: 2019/3/14 通过 SPI 检测服务端协议是否被消费端支持，不支持则抛出异常
            ...
            if (invoker == null) { // Not in the cache, refer again
                try {
                    ...
                    if (enabled) {
                        // TODO: 2019/3/14 调用 refer 获取 Invoker
    ...
    public List<Invoker<T>> doList(Invocation invocation) {
        if (forbidden) {
            ...
            // TODO: 2019/3/14  服务提供者关闭或禁用了服务，此时抛出 No provider 异常
